...
import usa.tesla.list.list2.car.detailRepo.ModelsRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		ModelsRepo mRepo = new ModelsRepo();
		String[] models = mRepo.detail();
		
		JTextField t1 = new JTextField(models[1]);
		JTextField t2 = new JTextField(models[2] + "円");
		JTextField t3 = new JTextField(models[3]);
		JTextField t4 = new JTextField(models[4]);
		JTextField t5 = new JTextField(models[5]);
		JTextField t6 = new JTextField(models[6]);
		JTextField t7 = new JTextField(models[7]);
		JTextField t8 = new JTextField(models[8]);
