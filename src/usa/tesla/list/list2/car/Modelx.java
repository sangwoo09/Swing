package usa.tesla.list.list2.car;
...
import usa.tesla.list.list2.List2;
import usa.tesla.list.list2.car.detailRepo.ModelxRepo;

public class Modelx extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		ModelxRepo mRepo = new ModelxRepo();
		String[] modelx = mRepo.detail();
		
		JTextField t1 = new JTextField(modelx[1]);
		JTextField t2 = new JTextField(modelx[2] + "円");
		JTextField t3 = new JTextField(modelx[3]);
		JTextField t4 = new JTextField(modelx[4]);
		JTextField t5 = new JTextField(modelx[5]);
		JTextField t6 = new JTextField(modelx[6]);
		JTextField t7 = new JTextField(modelx[7]);
		JTextField t8 = new JTextField(modelx[8]);
