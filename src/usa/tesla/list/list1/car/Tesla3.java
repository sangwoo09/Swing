...
import usa.tesla.list.list1.car.detailRepo.Tesla3Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Tesla3Repo tRepo = new Tesla3Repo();
		String[] tesla3 = tRepo.detail();
		
		JTextField t1 = new JTextField(tesla3[1]);
		JTextField t2 = new JTextField(tesla3[2] + "円");
		JTextField t3 = new JTextField(tesla3[3]);
		JTextField t4 = new JTextField(tesla3[4]);
		JTextField t5 = new JTextField(tesla3[5]);
		JTextField t6 = new JTextField(tesla3[6]);
		JTextField t7 = new JTextField(tesla3[7]);
		JTextField t8 = new JTextField(tesla3[8]);
