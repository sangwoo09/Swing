package usa.tesla.list.list1.car;
...
import usa.tesla.list.list1.List1;
import usa.tesla.list.list1.car.detailRepo.ModelyRepo;

public class Modely extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		ModelyRepo mRepo = new ModelyRepo();
		String[] modely = mRepo.detail();
		
		JTextField t1 = new JTextField(modely[1]);
		JTextField t2 = new JTextField(modely[2] + "円");
		JTextField t3 = new JTextField(modely[3]);
		JTextField t4 = new JTextField(modely[4]);
		JTextField t5 = new JTextField(modely[5]);
		JTextField t6 = new JTextField(modely[6]);
		JTextField t7 = new JTextField(modely[7]);
		JTextField t8 = new JTextField(modely[8]);
