package usa.chevrolet.list.list4.car;
...
import usa.chevrolet.list.list4.car.detailRepo.TahoRepo;

public class Taho extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		TahoRepo tRepo = new TahoRepo();
		String[] taho = tRepo.detail();
		
		JTextField t1 = new JTextField(taho[1]);
		JTextField t2 = new JTextField(taho[2] + "円");
		JTextField t3 = new JTextField(taho[3]);
		JTextField t4 = new JTextField(taho[4]);
		JTextField t5 = new JTextField(taho[5]);
		JTextField t6 = new JTextField(taho[6]);
		JTextField t7 = new JTextField(taho[7]);
		JTextField t8 = new JTextField(taho[8]);
