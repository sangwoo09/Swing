package usa.chevrolet.list.list3.car;
...
import usa.chevrolet.list.list3.car.detailRepo.ColoradoRepo;

public class Colorado extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public Colorado(){
		setTitle("COLORADOの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		ColoradoRepo cRepo = new ColoradoRepo();
		String[] colorado = cRepo.detail();
		
		JTextField t1 = new JTextField(colorado[1]);
		JTextField t2 = new JTextField(colorado[2] + "円");
		JTextField t3 = new JTextField(colorado[3]);
		JTextField t4 = new JTextField(colorado[4]);
		JTextField t5 = new JTextField(colorado[5]);
		JTextField t6 = new JTextField(colorado[6]);
		JTextField t7 = new JTextField(colorado[7]);
		JTextField t8 = new JTextField(colorado[8]);
