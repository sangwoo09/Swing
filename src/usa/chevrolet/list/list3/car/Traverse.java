...
import usa.chevrolet.list.list3.car.detailRepo.TraverseRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		TraverseRepo tRepo = new TraverseRepo();
		String[] traverse = tRepo.detail();
		
		JTextField t1 = new JTextField(traverse[1]);
		JTextField t2 = new JTextField(traverse[2] + "円");
		JTextField t3 = new JTextField(traverse[3]);
		JTextField t4 = new JTextField(traverse[4]);
		JTextField t5 = new JTextField(traverse[5]);
		JTextField t6 = new JTextField(traverse[6]);
		JTextField t7 = new JTextField(traverse[7]);
		JTextField t8 = new JTextField(traverse[8]);
