...
import usa.chevrolet.list.list1.car.detailRepo.VoltevRepo;

public class Voltev extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		VoltevRepo vRepo = new VoltevRepo();
		String[] voltev = vRepo.detail();
		
		JTextField t1 = new JTextField(voltev[1]);
		JTextField t2 = new JTextField(voltev[2] + "円");
		JTextField t3 = new JTextField(voltev[3]);
		JTextField t4 = new JTextField(voltev[4]);
		JTextField t5 = new JTextField(voltev[5]);
		JTextField t6 = new JTextField(voltev[6]);
		JTextField t7 = new JTextField(voltev[7]);
		JTextField t8 = new JTextField(voltev[8]);
