...
public class CSaveFrame extends JFrame{
	...
	private void Center() {
		...
		b3.addActionListener(e -> {
			...
			boolean result = crepo.save(syamei, price, nenryo, nenpi, syutsu, toruku, haiki, kudou);
			if(result) {
