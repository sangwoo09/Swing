...
import usa.ford.save.FSaveFrame;
...
public class Ford extends JFrame{
	...
	JButton b1 = new JButton("中型");
	JButton b2 = new JButton("準大型");
	JButton b3 = new JButton("大型");
	JButton b4 = new JButton("スポーツ");
