...
public class FSaveFrame extends JFrame{
	...
	private void Center() {
		...
		b3.addActionListener(e -> {
			...
			boolean result = frepo.save(syamei, price, nenryo, nenpi, syutsu, toruku, haiki, kudou);
			if(result) {
