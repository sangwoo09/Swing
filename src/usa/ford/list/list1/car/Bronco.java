package usa.ford.list.list1.car;
...
import usa.ford.list.list1.List1;
import usa.ford.list.list1.car.detailRepo.BroncoRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		BroncoRepo bRepo = new BroncoRepo();
		String[] bronco = bRepo.detail();
		
		JTextField t1 = new JTextField(bronco[1]);
		JTextField t2 = new JTextField(bronco[2] + "円");
		JTextField t3 = new JTextField(bronco[3]);
		JTextField t4 = new JTextField(bronco[4]);
		JTextField t5 = new JTextField(bronco[5]);
		JTextField t6 = new JTextField(bronco[6]);
		JTextField t7 = new JTextField(bronco[7]);
		JTextField t8 = new JTextField(bronco[8]);
