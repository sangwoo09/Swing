package usa.ford.list.list2.car;
...
import usa.ford.list.list2.List2;
import usa.ford.list.list2.car.detailRepo.ExplorerRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		ExplorerRepo eRepo = new ExplorerRepo();
		String[] explorer = eRepo.detail();
		
		JTextField t1 = new JTextField(explorer[1]);
		JTextField t2 = new JTextField(explorer[2] + "円");
		JTextField t3 = new JTextField(explorer[3]);
		JTextField t4 = new JTextField(explorer[4]);
		JTextField t5 = new JTextField(explorer[5]);
		JTextField t6 = new JTextField(explorer[6]);
		JTextField t7 = new JTextField(explorer[7]);
		JTextField t8 = new JTextField(explorer[8]);
