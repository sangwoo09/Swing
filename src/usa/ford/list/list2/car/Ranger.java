...
import usa.ford.list.list2.car.detailRepo.RangerRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		RangerRepo rRepo = new RangerRepo();
		String[] ranger = rRepo.detail();
		
		JTextField t1 = new JTextField(ranger[1]);
		JTextField t2 = new JTextField(ranger[2] + "円");
		JTextField t3 = new JTextField(ranger[3]);
		JTextField t4 = new JTextField(ranger[4]);
		JTextField t5 = new JTextField(ranger[5]);
		JTextField t6 = new JTextField(ranger[6]);
		JTextField t7 = new JTextField(ranger[7]);
		JTextField t8 = new JTextField(ranger[8]);
