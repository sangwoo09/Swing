...
import germany.audi.list.list3.car.detailRepo.Q5tfsiRepo;

public class Q5tfsi extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Q5tfsiRepo qRepo = new Q5tfsiRepo();
		String[] q5 = qRepo.detail();
		
		JTextField t1 = new JTextField(q5[1]);
		JTextField t2 = new JTextField(q5[2] + "円");
		JTextField t3 = new JTextField(q5[3]);
		JTextField t4 = new JTextField(q5[4]);
		JTextField t5 = new JTextField(q5[5]);
		JTextField t6 = new JTextField(q5[6]);
		JTextField t7 = new JTextField(q5[7]);
		JTextField t8 = new JTextField(q5[8]);
