package germany.audi.list.list3.car;
...
import germany.audi.list.list3.List3;
import germany.audi.list.list3.car.detailRepo.A5tfsiRepo;

public class A5tfsi extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A5tfsiRepo aRepo = new A5tfsiRepo();
		String[] a5 = aRepo.detail();
		
		JTextField t1 = new JTextField(a5[1]);
		JTextField t2 = new JTextField(a5[2] + "円");
		JTextField t3 = new JTextField(a5[3]);
		JTextField t4 = new JTextField(a5[4]);
		JTextField t5 = new JTextField(a5[5]);
		JTextField t6 = new JTextField(a5[6]);
		JTextField t7 = new JTextField(a5[7]);
		JTextField t8 = new JTextField(a5[8]);
