...
import germany.audi.list.list3.car.detailRepo.S4Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S4Repo sRepo = new S4Repo();
		String[] s4 = sRepo.detail();
		
		JTextField t1 = new JTextField(s4[1]);
		JTextField t2 = new JTextField(s4[2] + "円");
		JTextField t3 = new JTextField(s4[3]);
		JTextField t4 = new JTextField(s4[4]);
		JTextField t5 = new JTextField(s4[5]);
		JTextField t6 = new JTextField(s4[6]);
		JTextField t7 = new JTextField(s4[7]);
		JTextField t8 = new JTextField(s4[8]);
