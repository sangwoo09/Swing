...
import germany.audi.list.list3.car.detailRepo.S5Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S5Repo sRepo = new S5Repo();
		String[] s5 = sRepo.detail();
		
		JTextField t1 = new JTextField(s5[1]);
		JTextField t2 = new JTextField(s5[2] + "円");
		JTextField t3 = new JTextField(s5[3]);
		JTextField t4 = new JTextField(s5[4]);
		JTextField t5 = new JTextField(s5[5]);
		JTextField t6 = new JTextField(s5[6]);
		JTextField t7 = new JTextField(s5[7]);
		JTextField t8 = new JTextField(s5[8]);
