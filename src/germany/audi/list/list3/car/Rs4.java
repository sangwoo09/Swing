...
import germany.audi.list.list3.car.detailRepo.Rs4Repo;

public class Rs4 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Rs4Repo rsRepo = new Rs4Repo();
		String[] rs4 = rsRepo.detail();
		
		JTextField t1 = new JTextField(rs4[1]);
		JTextField t2 = new JTextField(rs4[2] + "€");
		JTextField t3 = new JTextField(rs4[3]);
		JTextField t4 = new JTextField(rs4[4]);
		JTextField t5 = new JTextField(rs4[5]);
		JTextField t6 = new JTextField(rs4[6]);
		JTextField t7 = new JTextField(rs4[7]);
		JTextField t8 = new JTextField(rs4[8]);
