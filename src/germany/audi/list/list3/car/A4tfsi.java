...
import germany.audi.list.list3.car.detailRepo.A4tfsiRepo;

public class A4tfsi extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A4tfsiRepo aRepo = new A4tfsiRepo();
		String[] a4 = aRepo.detail();
		
		JTextField t1 = new JTextField(a4[1]);
		JTextField t2 = new JTextField(a4[2] + "円");
		JTextField t3 = new JTextField(a4[3]);
		JTextField t4 = new JTextField(a4[4]);
		JTextField t5 = new JTextField(a4[5]);
		JTextField t6 = new JTextField(a4[6]);
		JTextField t7 = new JTextField(a4[7]);
		JTextField t8 = new JTextField(a4[8]);
