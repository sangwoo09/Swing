...
import germany.audi.list.list3.car.detailRepo.Rs5Repo;

public class Rs5 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Rs5Repo rsRepo = new Rs5Repo();
		String[] rs5 = rsRepo.detail();
		
		JTextField t1 = new JTextField(rs5[1]);
		JTextField t2 = new JTextField(rs5[2] + "円");
		JTextField t3 = new JTextField(rs5[3]);
		JTextField t4 = new JTextField(rs5[4]);
		JTextField t5 = new JTextField(rs5[5]);
		JTextField t6 = new JTextField(rs5[6]);
		JTextField t7 = new JTextField(rs5[7]);
		JTextField t8 = new JTextField(rs5[8]);
