...
import germany.audi.list.list3.car.detailRepo.Q4Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Q4Repo qRepo = new Q4Repo();
		String[] q4 = qRepo.detail();
		
		JTextField t1 = new JTextField(q4[1]);
		JTextField t2 = new JTextField(q4[2] + "円");
		JTextField t3 = new JTextField(q4[3]);
		JTextField t4 = new JTextField(q4[4]);
		JTextField t5 = new JTextField(q4[5]);
		JTextField t6 = new JTextField(q4[6]);
		JTextField t7 = new JTextField(q4[7]);
		JTextField t8 = new JTextField(q4[8]);
