...
import germany.audi.list.list4.car.detailRepo.Rs7Repo;

public class Rs7 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Rs7Repo rsRepo = new Rs7Repo();
		String[] rs7 = rsRepo.detail();
		
		JTextField t1 = new JTextField(rs7[1]);
		JTextField t2 = new JTextField(rs7[2] + "円");
		JTextField t3 = new JTextField(rs7[3]);
		JTextField t4 = new JTextField(rs7[4]);
		JTextField t5 = new JTextField(rs7[5]);
		JTextField t6 = new JTextField(rs7[6]);
		JTextField t7 = new JTextField(rs7[7]);
		JTextField t8 = new JTextField(rs7[8]);
