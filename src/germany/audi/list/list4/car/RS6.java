...
import germany.audi.list.list4.car.detailRepo.RS6Repo;

public class RS6 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		RS6Repo rsRepo = new RS6Repo();
		String[] rs6 = rsRepo.detail();
		
		JTextField t1 = new JTextField(rs6[1]);
		JTextField t2 = new JTextField(rs6[2] + "円");
		JTextField t3 = new JTextField(rs6[3]);
		JTextField t4 = new JTextField(rs6[4]);
		JTextField t5 = new JTextField(rs6[5]);
		JTextField t6 = new JTextField(rs6[6]);
		JTextField t7 = new JTextField(rs6[7]);
		JTextField t8 = new JTextField(rs6[8]);
