...
import germany.audi.list.list4.car.detailRepo.S6Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S6Repo sRepo = new S6Repo();
		String[] s6 = sRepo.detail();
		
		JTextField t1 = new JTextField(s6[1]);
		JTextField t2 = new JTextField(s6[2] + "円");
		JTextField t3 = new JTextField(s6[3]);
		JTextField t4 = new JTextField(s6[4]);
		JTextField t5 = new JTextField(s6[5]);
		JTextField t6 = new JTextField(s6[6]);
		JTextField t7 = new JTextField(s6[7]);
		JTextField t8 = new JTextField(s6[8]);
