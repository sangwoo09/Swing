...
import germany.audi.list.list4.car.detailRepo.A6tfsiRepo;

public class A6tfsi extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A6tfsiRepo aRepo = new A6tfsiRepo();
		String[] a6 = aRepo.detail();
		
		JTextField t1 = new JTextField(a6[1]);
		JTextField t2 = new JTextField(a6[2] + "円");
		JTextField t3 = new JTextField(a6[3]);
		JTextField t4 = new JTextField(a6[4]);
		JTextField t5 = new JTextField(a6[5]);
		JTextField t6 = new JTextField(a6[6]);
		JTextField t7 = new JTextField(a6[7]);
		JTextField t8 = new JTextField(a6[8]);
