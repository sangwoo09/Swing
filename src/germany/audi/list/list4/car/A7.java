...
import germany.audi.list.list4.car.detailRepo.A7Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A7Repo aRepo = new A7Repo();
		String[] a7 = aRepo.detail();
		
		JTextField t1 = new JTextField(a7[1]);
		JTextField t2 = new JTextField(a7[2] + "円");
		JTextField t3 = new JTextField(a7[3]);
		JTextField t4 = new JTextField(a7[4]);
		JTextField t5 = new JTextField(a7[5]);
		JTextField t6 = new JTextField(a7[6]);
		JTextField t7 = new JTextField(a7[7]);
		JTextField t8 = new JTextField(a7[8]);
