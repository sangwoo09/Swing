package germany.audi.list.list4.car;
...
import germany.audi.list.list4.List4;
import germany.audi.list.list4.car.detailRepo.Q7tfsiRepo;

public class Q7tfsi extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Q7tfsiRepo qRepo = new Q7tfsiRepo();
		String[] q7 = qRepo.detail();
		
		JTextField t1 = new JTextField(q7[1]);
		JTextField t2 = new JTextField(q7[2] + "円");
		JTextField t3 = new JTextField(q7[3]);
		JTextField t4 = new JTextField(q7[4]);
		JTextField t5 = new JTextField(q7[5]);
		JTextField t6 = new JTextField(q7[6]);
		JTextField t7 = new JTextField(q7[7]);
		JTextField t8 = new JTextField(q7[8]);
