...
import germany.audi.list.list4.car.detailRepo.S7Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S7Repo sRepo = new S7Repo();
		String[] s7 = sRepo.detail();
		
		JTextField t1 = new JTextField(s7[1]);
		JTextField t2 = new JTextField(s7[2] + "円");
		JTextField t3 = new JTextField(s7[3]);
		JTextField t4 = new JTextField(s7[4]);
		JTextField t5 = new JTextField(s7[5]);
		JTextField t6 = new JTextField(s7[6]);
		JTextField t7 = new JTextField(s7[7]);
		JTextField t8 = new JTextField(s7[8]);
