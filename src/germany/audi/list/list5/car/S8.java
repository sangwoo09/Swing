...
import germany.audi.list.list5.car.detailRepo.S8Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S8Repo sRepo = new S8Repo();
		String[] s8 = sRepo.detail();
		
		JTextField t1 = new JTextField(s8[1]);
		JTextField t2 = new JTextField(s8[2] + "円");
		JTextField t3 = new JTextField(s8[3]);
		JTextField t4 = new JTextField(s8[4]);
		JTextField t5 = new JTextField(s8[5]);
		JTextField t6 = new JTextField(s8[6]);
		JTextField t7 = new JTextField(s8[7]);
		JTextField t8 = new JTextField(s8[8]);
