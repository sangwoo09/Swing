...
import germany.audi.list.list5.car.detailRepo.A8Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A8Repo aRepo = new A8Repo();
		String[] a8 = aRepo.detail();
		
		JTextField t1 = new JTextField(a8[1]);
		JTextField t2 = new JTextField(a8[2] + "円");
		JTextField t3 = new JTextField(a8[3]);
		JTextField t4 = new JTextField(a8[4]);
		JTextField t5 = new JTextField(a8[5]);
		JTextField t6 = new JTextField(a8[6]);
		JTextField t7 = new JTextField(a8[7]);
		JTextField t8 = new JTextField(a8[8]);
