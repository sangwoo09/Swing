...
import germany.audi.list.list5.car.detailRepo.R8Repo;

public class R8 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		R8Repo rRepo = new R8Repo();
		String[] r8 = rRepo.detail();
		
		JTextField t1 = new JTextField(r8[1]);
		JTextField t2 = new JTextField(r8[2] + "円");
		JTextField t3 = new JTextField(r8[3]);
		JTextField t4 = new JTextField(r8[4]);
		JTextField t5 = new JTextField(r8[5]);
		JTextField t6 = new JTextField(r8[6]);
		JTextField t7 = new JTextField(r8[7]);
		JTextField t8 = new JTextField(r8[8]);
