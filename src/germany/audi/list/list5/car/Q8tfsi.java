package germany.audi.list.list5.car;
...
import germany.audi.list.list5.List5;
import germany.audi.list.list5.car.detailRepo.Q8tfsiRepo;

public class Q8tfsi extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Q8tfsiRepo qRepo = new Q8tfsiRepo();
		String[] q8 = qRepo.detail();
		
		JTextField t1 = new JTextField(q8[1]);
		JTextField t2 = new JTextField(q8[2] + "円");
		JTextField t3 = new JTextField(q8[3]);
		JTextField t4 = new JTextField(q8[4]);
		JTextField t5 = new JTextField(q8[5]);
		JTextField t6 = new JTextField(q8[6]);
		JTextField t7 = new JTextField(q8[7]);
		JTextField t8 = new JTextField(q8[8]);
