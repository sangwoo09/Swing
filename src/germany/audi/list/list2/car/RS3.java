package germany.audi.list.list2.car;
...
import germany.audi.list.list2.List2;
import germany.audi.list.list2.car.detailRepo.RS3Repo;

public class RS3 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		RS3Repo rRepo = new RS3Repo();
		String[] rs3 = rRepo.detail();
		
		JTextField t1 = new JTextField(rs3[1]);
		JTextField t2 = new JTextField(rs3[2] + "円");
		JTextField t3 = new JTextField(rs3[3]);
		JTextField t4 = new JTextField(rs3[4]);
		JTextField t5 = new JTextField(rs3[5]);
		JTextField t6 = new JTextField(rs3[6]);
		JTextField t7 = new JTextField(rs3[7]);
		JTextField t8 = new JTextField(rs3[8]);
