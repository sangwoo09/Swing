...
import germany.audi.list.list2.car.detailRepo.A3Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A3Repo aRepo = new A3Repo();
		String[] a3 = aRepo.detail();
		
		JTextField t1 = new JTextField(a3[1]);
		JTextField t2 = new JTextField(a3[2] + "円");
		JTextField t3 = new JTextField(a3[3]);
		JTextField t4 = new JTextField(a3[4]);
		JTextField t5 = new JTextField(a3[5]);
		JTextField t6 = new JTextField(a3[6]);
		JTextField t7 = new JTextField(a3[7]);
		JTextField t8 = new JTextField(a3[8]);
