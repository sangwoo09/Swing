...
import germany.audi.list.list2.car.detailRepo.Q3Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Q3Repo qRepo = new Q3Repo();
		String[] q3 = qRepo.detail();
		
		JTextField t1 = new JTextField(q3[1]);
		JTextField t2 = new JTextField(q3[2] + "円");
		JTextField t3 = new JTextField(q3[3]);
		JTextField t4 = new JTextField(q3[4]);
		JTextField t5 = new JTextField(q3[5]);
		JTextField t6 = new JTextField(q3[6]);
		JTextField t7 = new JTextField(q3[7]);
		JTextField t8 = new JTextField(q3[8]);
