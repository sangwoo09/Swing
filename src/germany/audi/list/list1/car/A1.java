...
import germany.audi.list.list1.car.detailRepo.A1Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A1Repo aRepo = new A1Repo();
		String[] a1 = aRepo.detail();
		
		JTextField t1 = new JTextField(a1[1]);
		JTextField t2 = new JTextField(a1[2] + "円");
		JTextField t3 = new JTextField(a1[3]);
		JTextField t4 = new JTextField(a1[4]);
		JTextField t5 = new JTextField(a1[5]);
		JTextField t6 = new JTextField(a1[6]);
		JTextField t7 = new JTextField(a1[7]);
		JTextField t8 = new JTextField(a1[8]);
