...
import germany.benz.list.list2.car.detailRepo.C43Repo;

public class C43 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		C43Repo cRepo = new C43Repo();
		String[] c43 = cRepo.detail();
		
		JTextField t1 = new JTextField(c43[1]);
		JTextField t2 = new JTextField(c43[2] + "円");
		JTextField t3 = new JTextField(c43[3]);
		JTextField t4 = new JTextField(c43[4]);
		JTextField t5 = new JTextField(c43[5]);
		JTextField t6 = new JTextField(c43[6]);
		JTextField t7 = new JTextField(c43[7]);
		JTextField t8 = new JTextField(c43[8]);
