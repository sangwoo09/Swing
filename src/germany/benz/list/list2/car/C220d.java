...
import germany.benz.list.list2.car.detailRepo.C220dRepo;

public class C220d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		C220dRepo cRepo = new C220dRepo();
		String[] c220d = cRepo.detail();
		
		JTextField t1 = new JTextField(c220d[1]);
		JTextField t2 = new JTextField(c220d[2] + "円");
		JTextField t3 = new JTextField(c220d[3]);
		JTextField t4 = new JTextField(c220d[4]);
		JTextField t5 = new JTextField(c220d[5]);
		JTextField t6 = new JTextField(c220d[6]);
		JTextField t7 = new JTextField(c220d[7]);
		JTextField t8 = new JTextField(c220d[8]);
