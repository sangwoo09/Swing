...
import germany.benz.list.list2.car.detailRepo.C200Repo;

public class C200 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		C200Repo cRepo = new C200Repo();
		String[] c200 = cRepo.detail();
		
		JTextField t1 = new JTextField(c200[1]);
		JTextField t2 = new JTextField(c200[2] + "円");
		JTextField t3 = new JTextField(c200[3]);
		JTextField t4 = new JTextField(c200[4]);
		JTextField t5 = new JTextField(c200[5]);
		JTextField t6 = new JTextField(c200[6]);
		JTextField t7 = new JTextField(c200[7]);
		JTextField t8 = new JTextField(c200[8]);
