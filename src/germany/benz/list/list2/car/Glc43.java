...
import germany.benz.list.list2.car.detailRepo.Glc43Repo;

public class Glc43 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Glc43Repo gRepo = new Glc43Repo();
		String[] glc43 = gRepo.detail();
		
		JTextField t1 = new JTextField(glc43[1]);
		JTextField t2 = new JTextField(glc43[2] + "円");
		JTextField t3 = new JTextField(glc43[3]);
		JTextField t4 = new JTextField(glc43[4]);
		JTextField t5 = new JTextField(glc43[5]);
		JTextField t6 = new JTextField(glc43[6]);
		JTextField t7 = new JTextField(glc43[7]);
		JTextField t8 = new JTextField(glc43[8]);
