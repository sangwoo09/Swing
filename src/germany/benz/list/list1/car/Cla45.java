...
import germany.benz.list.list1.car.detailRepo.Cla45Repo;

public class Cla45 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Cla45Repo cRepo = new Cla45Repo();
		String[] cla45 = cRepo.detail();
		
		JTextField t1 = new JTextField(cla45[1]);
		JTextField t2 = new JTextField(cla45[2] + "円");
		JTextField t3 = new JTextField(cla45[3]);
		JTextField t4 = new JTextField(cla45[4]);
		JTextField t5 = new JTextField(cla45[5]);
		JTextField t6 = new JTextField(cla45[6]);
		JTextField t7 = new JTextField(cla45[7]);
		JTextField t8 = new JTextField(cla45[8]);
