...
import germany.benz.list.list1.car.detailRepo.Glb35Repo;

public class Glb35 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Glb35Repo gRepo = new Glb35Repo();
		String[] glb35 = gRepo.detail();
		
		JTextField t1 = new JTextField(glb35[1]);
		JTextField t2 = new JTextField(glb35[2] + "円");
		JTextField t3 = new JTextField(glb35[3]);
		JTextField t4 = new JTextField(glb35[4]);
		JTextField t5 = new JTextField(glb35[5]);
		JTextField t6 = new JTextField(glb35[6]);
		JTextField t7 = new JTextField(glb35[7]);
		JTextField t8 = new JTextField(glb35[8]);
