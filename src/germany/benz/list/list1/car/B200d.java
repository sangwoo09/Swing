...
import germany.benz.list.list1.car.detailRepo.B200dRepo;

public class B200d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B200dRepo bRepo = new B200dRepo();
		String[] b200d = bRepo.detail();
		
		JTextField t1 = new JTextField(b200d[1]);
		JTextField t2 = new JTextField(b200d[2] + "円");
		JTextField t3 = new JTextField(b200d[3]);
		JTextField t4 = new JTextField(b200d[4]);
		JTextField t5 = new JTextField(b200d[5]);
		JTextField t6 = new JTextField(b200d[6]);
		JTextField t7 = new JTextField(b200d[7]);
		JTextField t8 = new JTextField(b200d[8]);
