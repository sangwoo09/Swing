...
import germany.benz.list.list1.car.detailRepo.A220Repo;

public class A220 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A220Repo aRepo = new A220Repo();
		String[] a220 = aRepo.detail();
		
		JTextField t1 = new JTextField(a220[1]);
		JTextField t2 = new JTextField(a220[2] + "円");
		JTextField t3 = new JTextField(a220[3]);
		JTextField t4 = new JTextField(a220[4]);
		JTextField t5 = new JTextField(a220[5]);
		JTextField t6 = new JTextField(a220[6]);
		JTextField t7 = new JTextField(a220[7]);
		JTextField t8 = new JTextField(a220[8]);
