...
import germany.benz.list.list1.car.detailRepo.B220Repo;

public class B220 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B220Repo bRepo = new B220Repo();
		String[] b220 = bRepo.detail();
		
		JTextField t1 = new JTextField(b220[1]);
		JTextField t2 = new JTextField(b220[2] + "円");
		JTextField t3 = new JTextField(b220[3]);
		JTextField t4 = new JTextField(b220[4]);
		JTextField t5 = new JTextField(b220[5]);
		JTextField t6 = new JTextField(b220[6]);
		JTextField t7 = new JTextField(b220[7]);
		JTextField t8 = new JTextField(b220[8]);
