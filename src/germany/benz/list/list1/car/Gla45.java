...
import germany.benz.list.list1.car.detailRepo.Gla45Repo;

public class Gla45 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Gla45Repo gRepo = new Gla45Repo();
		String[] gla45 = gRepo.detail();
		
		JTextField t1 = new JTextField(gla45[1]);
		JTextField t2 = new JTextField(gla45[2] + "円");
		JTextField t3 = new JTextField(gla45[3]);
		JTextField t4 = new JTextField(gla45[4]);
		JTextField t5 = new JTextField(gla45[5]);
		JTextField t6 = new JTextField(gla45[6]);
		JTextField t7 = new JTextField(gla45[7]);
		JTextField t8 = new JTextField(gla45[8]);
