...
import germany.benz.list.list1.car.detailRepo.A45Repo;

public class A45 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		A45Repo aRepo = new A45Repo();
		String[] a45 = aRepo.detail();
		
		JTextField t1 = new JTextField(a45[1]);
		JTextField t2 = new JTextField(a45[2] + "円");
		JTextField t3 = new JTextField(a45[3]);
		JTextField t4 = new JTextField(a45[4]);
		JTextField t5 = new JTextField(a45[5]);
		JTextField t6 = new JTextField(a45[6]);
		JTextField t7 = new JTextField(a45[7]);
		JTextField t8 = new JTextField(a45[8]);
