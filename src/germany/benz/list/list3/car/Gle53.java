...
import germany.benz.list.list3.car.detailRepo.Gle53Repo;

public class Gle53 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Gle53Repo gRepo = new Gle53Repo();
		String[] gle53 = gRepo.detail();
		
		JTextField t1 = new JTextField(gle53[1]);
		JTextField t2 = new JTextField(gle53[2] + "円");
		JTextField t3 = new JTextField(gle53[3]);
		JTextField t4 = new JTextField(gle53[4]);
		JTextField t5 = new JTextField(gle53[5]);
		JTextField t6 = new JTextField(gle53[6]);
		JTextField t7 = new JTextField(gle53[7]);
		JTextField t8 = new JTextField(gle53[8]);
