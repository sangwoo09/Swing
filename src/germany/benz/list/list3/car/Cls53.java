...
import germany.benz.list.list3.car.detailRepo.Cls53Repo;

public class Cls53 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Cls53Repo cRepo = new Cls53Repo();
		String[] cls53 = cRepo.detail();
		
		JTextField t1 = new JTextField(cls53[1]);
		JTextField t2 = new JTextField(cls53[2] + "円");
		JTextField t3 = new JTextField(cls53[3]);
		JTextField t4 = new JTextField(cls53[4]);
		JTextField t5 = new JTextField(cls53[5]);
		JTextField t6 = new JTextField(cls53[6]);
		JTextField t7 = new JTextField(cls53[7]);
		JTextField t8 = new JTextField(cls53[8]);
