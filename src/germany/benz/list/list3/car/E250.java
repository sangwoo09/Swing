...
import germany.benz.list.list3.car.detailRepo.E250Repo;

public class E250 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		E250Repo eRepo = new E250Repo();
		String[] e250 = eRepo.detail();
		
		JTextField t1 = new JTextField(e250[1]);
		JTextField t2 = new JTextField(e250[2] + "円");
		JTextField t3 = new JTextField(e250[3]);
		JTextField t4 = new JTextField(e250[4]);
		JTextField t5 = new JTextField(e250[5]);
		JTextField t6 = new JTextField(e250[6]);
		JTextField t7 = new JTextField(e250[7]);
		JTextField t8 = new JTextField(e250[8]);
