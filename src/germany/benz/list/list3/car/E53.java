...
import germany.benz.list.list3.car.detailRepo.E53Repo;

public class E53 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		E53Repo eRepo = new E53Repo();
		String[] e53 = eRepo.detail();
		
		JTextField t1 = new JTextField(e53[1]);
		JTextField t2 = new JTextField(e53[2] + "円");
		JTextField t3 = new JTextField(e53[3]);
		JTextField t4 = new JTextField(e53[4]);
		JTextField t5 = new JTextField(e53[5]);
		JTextField t6 = new JTextField(e53[6]);
		JTextField t7 = new JTextField(e53[7]);
		JTextField t8 = new JTextField(e53[8]);
