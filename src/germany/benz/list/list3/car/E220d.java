...
import germany.benz.list.list3.car.detailRepo.E220dRepo;

public class E220d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		E220dRepo eRepo = new E220dRepo();
		String[] e220d = eRepo.detail();
		
		JTextField t1 = new JTextField(e220d[1]);
		JTextField t2 = new JTextField(e220d[2] + "円");
		JTextField t3 = new JTextField(e220d[3]);
		JTextField t4 = new JTextField(e220d[4]);
		JTextField t5 = new JTextField(e220d[5]);
		JTextField t6 = new JTextField(e220d[6]);
		JTextField t7 = new JTextField(e220d[7]);
		JTextField t8 = new JTextField(e220d[8]);
