...
import germany.benz.list.list4.car.detailRepo.S500Repo;

public class S500 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S500Repo sRepo = new S500Repo();
		String[] s500 = sRepo.detail();
		
		JTextField t1 = new JTextField(s500[1]);
		JTextField t2 = new JTextField(s500[2] + "円");
		JTextField t3 = new JTextField(s500[3]);
		JTextField t4 = new JTextField(s500[4]);
		JTextField t5 = new JTextField(s500[5]);
		JTextField t6 = new JTextField(s500[6]);
		JTextField t7 = new JTextField(s500[7]);
		JTextField t8 = new JTextField(s500[8]);
