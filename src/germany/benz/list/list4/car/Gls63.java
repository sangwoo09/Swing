...
import germany.benz.list.list4.car.detailRepo.Gls63Repo;

public class Gls63 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Gls63Repo gRepo = new Gls63Repo();
		String[] gls63 = gRepo.detail();
		
		JTextField t1 = new JTextField(gls63[1]);
		JTextField t2 = new JTextField(gls63[2] + "円");
		JTextField t3 = new JTextField(gls63[3]);
		JTextField t4 = new JTextField(gls63[4]);
		JTextField t5 = new JTextField(gls63[5]);
		JTextField t6 = new JTextField(gls63[6]);
		JTextField t7 = new JTextField(gls63[7]);
		JTextField t8 = new JTextField(gls63[8]);
