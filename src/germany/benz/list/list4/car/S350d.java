...
import germany.benz.list.list4.car.detailRepo.S350dRepo;

public class S350d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S350dRepo sRepo = new S350dRepo();
		String[] s350d = sRepo.detail();
		
		JTextField t1 = new JTextField(s350d[1]);
		JTextField t2 = new JTextField(s350d[2] + "円");
		JTextField t3 = new JTextField(s350d[3]);
		JTextField t4 = new JTextField(s350d[4]);
		JTextField t5 = new JTextField(s350d[5]);
		JTextField t6 = new JTextField(s350d[6]);
		JTextField t7 = new JTextField(s350d[7]);
		JTextField t8 = new JTextField(s350d[8]);
