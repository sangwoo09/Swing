...
import germany.benz.list.list4.car.detailRepo.S63Repo;

public class S63 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		S63Repo sRepo = new S63Repo();
		String[] s63 = sRepo.detail();
		
		JTextField t1 = new JTextField(s63[1]);
		JTextField t2 = new JTextField(s63[2] + "円");
		JTextField t3 = new JTextField(s63[3]);
		JTextField t4 = new JTextField(s63[4]);
		JTextField t5 = new JTextField(s63[5]);
		JTextField t6 = new JTextField(s63[6]);
		JTextField t7 = new JTextField(s63[7]);
		JTextField t8 = new JTextField(s63[8]);
