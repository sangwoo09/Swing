package germany.volkswagen.list.list2.car;
...
import germany.volkswagen.list.list2.car.detailRepo.ArteonRepo;

public class Arteon extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		ArteonRepo aRepo = new ArteonRepo();
		String[] arteon = aRepo.detail();
		
		JTextField t1 = new JTextField(arteon[1]);
		JTextField t2 = new JTextField(arteon[2] + "円");
		JTextField t3 = new JTextField(arteon[3]);
		JTextField t4 = new JTextField(arteon[4]);
		JTextField t5 = new JTextField(arteon[5]);
		JTextField t6 = new JTextField(arteon[6]);
		JTextField t7 = new JTextField(arteon[7]);
		JTextField t8 = new JTextField(arteon[8]);
