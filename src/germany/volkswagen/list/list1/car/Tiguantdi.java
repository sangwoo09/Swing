package germany.volkswagen.list.list1.car;
...
import germany.volkswagen.list.list1.car.detailRepo.TiguantdiRepo;

public class Tiguantdi extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public Tiguantdi(){
		setTitle("TIGUAN TDIの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		TiguantdiRepo tRepo = new TiguantdiRepo();
		String[] tiguan = tRepo.detail();
		
		JTextField t1 = new JTextField(tiguan[1]);
		JTextField t2 = new JTextField(tiguan[2] + "円");
		JTextField t3 = new JTextField(tiguan[3]);
		JTextField t4 = new JTextField(tiguan[4]);
		JTextField t5 = new JTextField(tiguan[5]);
		JTextField t6 = new JTextField(tiguan[6]);
		JTextField t7 = new JTextField(tiguan[7]);
		JTextField t8 = new JTextField(tiguan[8]);
