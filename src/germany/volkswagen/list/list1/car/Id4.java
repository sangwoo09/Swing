...
import germany.volkswagen.list.list1.car.detailRepo.Id4Repo;

public class Id4 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Id4Repo iRepo = new Id4Repo();
		String[] id4 = iRepo.detail();
		
		JTextField t1 = new JTextField(id4[1]);
		JTextField t2 = new JTextField(id4[2] + "円");
		JTextField t3 = new JTextField(id4[3]);
		JTextField t4 = new JTextField(id4[4]);
		JTextField t5 = new JTextField(id4[5]);
		JTextField t6 = new JTextField(id4[6]);
		JTextField t7 = new JTextField(id4[7]);
		JTextField t8 = new JTextField(id4[8]);
