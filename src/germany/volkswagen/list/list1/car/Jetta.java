...
import germany.volkswagen.list.list1.car.detailRepo.JettaRepo;

public class Jetta extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		JettaRepo jRepo = new JettaRepo();
		String[] jetta = jRepo.detail();
		
		JTextField t1 = new JTextField(jetta[1]);
		JTextField t2 = new JTextField(jetta[2] + "円");
		JTextField t3 = new JTextField(jetta[3]);
		JTextField t4 = new JTextField(jetta[4]);
		JTextField t5 = new JTextField(jetta[5]);
		JTextField t6 = new JTextField(jetta[6]);
		JTextField t7 = new JTextField(jetta[7]);
		JTextField t8 = new JTextField(jetta[8]);
