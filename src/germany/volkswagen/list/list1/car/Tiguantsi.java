...
import germany.volkswagen.list.list1.car.detailRepo.TiguantsiRepo;

public class Tiguantsi extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public Tiguantsi(){
		setTitle("TIGUAN TSIの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		TiguantsiRepo tRepo = new TiguantsiRepo();
