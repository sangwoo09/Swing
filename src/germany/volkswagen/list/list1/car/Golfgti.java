...
import germany.volkswagen.list.list1.car.detailRepo.GolfgtiRepo;

public class Golfgti extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public Golfgti(){
		setTitle("GOLF GTIの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		GolfgtiRepo gRepo = new GolfgtiRepo();
		String[] golf = gRepo.detail();
		
		JTextField t1 = new JTextField(golf[1]);
		JTextField t2 = new JTextField(golf[2] + "円");
		JTextField t3 = new JTextField(golf[3]);
		JTextField t4 = new JTextField(golf[4]);
		JTextField t5 = new JTextField(golf[5]);
		JTextField t6 = new JTextField(golf[6]);
		JTextField t7 = new JTextField(golf[7]);
		JTextField t8 = new JTextField(golf[8]);
