package germany.volkswagen.save;
...
public class VSaveFrame extends JFrame{
	...
	private void Center() {
		...
		b3.addActionListener(e -> {
			...
			boolean result = repo.save(syamei, price, nenryo, nenpi, syutsu, toruku, haiki, kudou);
			if(result) {
