...
import germany.bmw.list.list1.detailrepo.M135iRepo;

public class M135i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		M135iRepo mRepo = new M135iRepo();
		String[] m135i = mRepo.detail();
		
		JTextField t1 = new JTextField(m135i[1]);
		JTextField t2 = new JTextField(m135i[2] + "円");
		JTextField t3 = new JTextField(m135i[3]);
		JTextField t4 = new JTextField(m135i[4]);
		JTextField t5 = new JTextField(m135i[5]);
		JTextField t6 = new JTextField(m135i[6]);
		JTextField t7 = new JTextField(m135i[7]);
		JTextField t8 = new JTextField(m135i[8]);
