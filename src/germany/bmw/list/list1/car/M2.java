...
import germany.bmw.list.list1.detailrepo.M2Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		M2Repo mRepo = new M2Repo();
		String[] m2 = mRepo.detail();
		
		JTextField t1 = new JTextField(m2[1]);
		JTextField t2 = new JTextField(m2[2] + "円");
		JTextField t3 = new JTextField(m2[3]);
		JTextField t4 = new JTextField(m2[4]);
		JTextField t5 = new JTextField(m2[5]);
		JTextField t6 = new JTextField(m2[6]);
		JTextField t7 = new JTextField(m2[7]);
		JTextField t8 = new JTextField(m2[8]);
