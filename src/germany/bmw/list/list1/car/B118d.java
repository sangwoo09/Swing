...
import germany.bmw.list.list1.detailrepo.B118dRepo;

public class B118d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B118dRepo bRepo = new B118dRepo();
		String[] b118d = bRepo.detail();
		
		JTextField t1 = new JTextField(b118d[1]);
		JTextField t2 = new JTextField(b118d[2] + "円");
		JTextField t3 = new JTextField(b118d[3]);
		JTextField t4 = new JTextField(b118d[4]);
		JTextField t5 = new JTextField(b118d[5]);
		JTextField t6 = new JTextField(b118d[6]);
		JTextField t7 = new JTextField(b118d[7]);
		JTextField t8 = new JTextField(b118d[8]);
