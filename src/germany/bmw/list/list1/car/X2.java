...
import germany.bmw.list.list1.detailrepo.X2Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		X2Repo xRepo = new X2Repo();
		String[] x2 = xRepo.detail();
		
		JTextField t1 = new JTextField(x2[1]);
		JTextField t2 = new JTextField(x2[2] + "円");
		JTextField t3 = new JTextField(x2[3]);
		JTextField t4 = new JTextField(x2[4]);
		JTextField t5 = new JTextField(x2[5]);
		JTextField t6 = new JTextField(x2[6]);
		JTextField t7 = new JTextField(x2[7]);
		JTextField t8 = new JTextField(x2[8]);
