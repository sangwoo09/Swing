package germany.bmw.list.list1.car;
...
import germany.bmw.list.list1.detailrepo.B120iRepo;

public class B120i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B120iRepo biRepo = new B120iRepo();
		String[] b120i = biRepo.detail();
		
		JTextField t1 = new JTextField(b120i[1]);
		JTextField t2 = new JTextField(b120i[2] + "円");
		JTextField t3 = new JTextField(b120i[3]);
		JTextField t4 = new JTextField(b120i[4]);
		JTextField t5 = new JTextField(b120i[5]);
		JTextField t6 = new JTextField(b120i[6]);
		JTextField t7 = new JTextField(b120i[7]);
		JTextField t8 = new JTextField(b120i[8]);
