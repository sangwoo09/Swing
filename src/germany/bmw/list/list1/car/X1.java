...
import germany.bmw.list.list1.detailrepo.X1Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		X1Repo xRepo = new X1Repo();
		String[] x1 = xRepo.detail();
		
		JTextField t1 = new JTextField(x1[1]);
		JTextField t2 = new JTextField(x1[2] + "円");
		JTextField t3 = new JTextField(x1[3]);
		JTextField t4 = new JTextField(x1[4]);
		JTextField t5 = new JTextField(x1[5]);
		JTextField t6 = new JTextField(x1[6]);
		JTextField t7 = new JTextField(x1[7]);
		JTextField t8 = new JTextField(x1[8]);
