...
import germany.bmw.list.list1.detailrepo.B218dRepo;

public class B218d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B218dRepo bRepo = new B218dRepo();
		String[] b218d = bRepo.detail();
		
		JTextField t1 = new JTextField(b218d[1]);
		JTextField t2 = new JTextField(b218d[2] + "円");
		JTextField t3 = new JTextField(b218d[3]);
		JTextField t4 = new JTextField(b218d[4]);
		JTextField t5 = new JTextField(b218d[5]);
		JTextField t6 = new JTextField(b218d[6]);
		JTextField t7 = new JTextField(b218d[7]);
		JTextField t8 = new JTextField(b218d[8]);
