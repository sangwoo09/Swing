...
import germany.bmw.list.list1.detailrepo.B220iRepo;

public class B220i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B220iRepo bRepo = new B220iRepo();
		String[] b220i = bRepo.detail();
		
		JTextField t1 = new JTextField(b220i[1]);
		JTextField t2 = new JTextField(b220i[2] + "円");
		JTextField t3 = new JTextField(b220i[3]);
		JTextField t4 = new JTextField(b220i[4]);
		JTextField t5 = new JTextField(b220i[5]);
		JTextField t6 = new JTextField(b220i[6]);
		JTextField t7 = new JTextField(b220i[7]);
		JTextField t8 = new JTextField(b220i[8]);
