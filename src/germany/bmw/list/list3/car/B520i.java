...
import germany.bmw.list.list3.car.detailRepo.B520iRepo;

public class B520i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B520iRepo bRepo = new B520iRepo();
		String[] b520i = bRepo.detail();
		
		JTextField t1 = new JTextField(b520i[1]);
		JTextField t2 = new JTextField(b520i[2] + "円");
		JTextField t3 = new JTextField(b520i[3]);
		JTextField t4 = new JTextField(b520i[4]);
		JTextField t5 = new JTextField(b520i[5]);
		JTextField t6 = new JTextField(b520i[6]);
		JTextField t7 = new JTextField(b520i[7]);
		JTextField t8 = new JTextField(b520i[8]);
