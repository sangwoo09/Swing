...
import germany.bmw.list.list3.car.detailRepo.X5dRepo;

public class X5d extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X5d(){
		setTitle("X5 xDrive30dの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X5dRepo xRepo = new X5dRepo();
		String[] x5d = xRepo.detail();
		
		JTextField t1 = new JTextField(x5d[1]);
		JTextField t2 = new JTextField(x5d[2] + "円");
		JTextField t3 = new JTextField(x5d[3]);
		JTextField t4 = new JTextField(x5d[4]);
		JTextField t5 = new JTextField(x5d[5]);
		JTextField t6 = new JTextField(x5d[6]);
		JTextField t7 = new JTextField(x5d[7]);
		JTextField t8 = new JTextField(x5d[8]);
