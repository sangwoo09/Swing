package germany.bmw.list.list3.car;
...
import germany.bmw.list.list3.car.detailRepo.B630iRepo;

public class B630i extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public B630i(){
		setTitle("630i xDriveの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		B630iRepo bRepo = new B630iRepo();
		String[] b630i = bRepo.detail();
		
		JTextField t1 = new JTextField(b630i[1]);
		JTextField t2 = new JTextField(b630i[2] + "円");
		JTextField t3 = new JTextField(b630i[3]);
		JTextField t4 = new JTextField(b630i[4]);
		JTextField t5 = new JTextField(b630i[5]);
		JTextField t6 = new JTextField(b630i[6]);
		JTextField t7 = new JTextField(b630i[7]);
		JTextField t8 = new JTextField(b630i[8]);
