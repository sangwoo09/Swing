...
import germany.bmw.list.list3.car.detailRepo.X6mRepo;

public class X6m extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		X6mRepo xRepo = new X6mRepo();
		String[] x6m = xRepo.detail();
		
		JTextField t1 = new JTextField(x6m[1]);
		JTextField t2 = new JTextField(x6m[2] + "円");
		JTextField t3 = new JTextField(x6m[3]);
		JTextField t4 = new JTextField(x6m[4]);
		JTextField t5 = new JTextField(x6m[5]);
		JTextField t6 = new JTextField(x6m[6]);
		JTextField t7 = new JTextField(x6m[7]);
		JTextField t8 = new JTextField(x6m[8]);
