...
import germany.bmw.list.list3.car.detailRepo.X6dRepo;

public class X6d extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X6d(){
		setTitle("X6 xDrive30dの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X6dRepo xRepo = new X6dRepo();
		String[] x6d = xRepo.detail();
		
		JTextField t1 = new JTextField(x6d[1]);
		JTextField t2 = new JTextField(x6d[2] + "円");
		JTextField t3 = new JTextField(x6d[3]);
		JTextField t4 = new JTextField(x6d[4]);
		JTextField t5 = new JTextField(x6d[5]);
		JTextField t6 = new JTextField(x6d[6]);
		JTextField t7 = new JTextField(x6d[7]);
		JTextField t8 = new JTextField(x6d[8]);
