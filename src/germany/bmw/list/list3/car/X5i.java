...
import germany.bmw.list.list3.car.detailRepo.X5iRepo;

public class X5i extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X5i(){
		setTitle("X5 xDrive40iの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X5iRepo xRepo = new X5iRepo();
		String[] x5i = xRepo.detail();
		
		JTextField t1 = new JTextField(x5i[1]);
		JTextField t2 = new JTextField(x5i[2] + "円");
		JTextField t3 = new JTextField(x5i[3]);
		JTextField t4 = new JTextField(x5i[4]);
		JTextField t5 = new JTextField(x5i[5]);
		JTextField t6 = new JTextField(x5i[6]);
		JTextField t7 = new JTextField(x5i[7]);
		JTextField t8 = new JTextField(x5i[8]);
