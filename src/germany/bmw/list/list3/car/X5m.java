...
import germany.bmw.list.list3.car.detailRepo.X5mRepo;

public class X5m extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		X5mRepo xRepo = new X5mRepo();
		String[] x5m = xRepo.detail();
		
		JTextField t1 = new JTextField(x5m[1]);
		JTextField t2 = new JTextField(x5m[2] + "円");
		JTextField t3 = new JTextField(x5m[3]);
		JTextField t4 = new JTextField(x5m[4]);
		JTextField t5 = new JTextField(x5m[5]);
		JTextField t6 = new JTextField(x5m[6]);
		JTextField t7 = new JTextField(x5m[7]);
		JTextField t8 = new JTextField(x5m[8]);
