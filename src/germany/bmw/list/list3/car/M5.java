...
import germany.bmw.list.list3.car.detailRepo.M5Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		M5Repo mRepo = new M5Repo();
		String[] m5 = mRepo.detail();
		
		JTextField t1 = new JTextField(m5[1]);
		JTextField t2 = new JTextField(m5[2] + "円");
		JTextField t3 = new JTextField(m5[3]);
		JTextField t4 = new JTextField(m5[4]);
		JTextField t5 = new JTextField(m5[5]);
		JTextField t6 = new JTextField(m5[6]);
		JTextField t7 = new JTextField(m5[7]);
		JTextField t8 = new JTextField(m5[8]);
