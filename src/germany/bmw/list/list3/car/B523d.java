...
import germany.bmw.list.list3.car.detailRepo.B523dRepo;

public class B523d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B523dRepo bRepo = new B523dRepo();
		String[] b523d = bRepo.detail();
		
		JTextField t1 = new JTextField(b523d[1]);
		JTextField t2 = new JTextField(b523d[2] + "円");
		JTextField t3 = new JTextField(b523d[3]);
		JTextField t4 = new JTextField(b523d[4]);
		JTextField t5 = new JTextField(b523d[5]);
		JTextField t6 = new JTextField(b523d[6]);
		JTextField t7 = new JTextField(b523d[7]);
		JTextField t8 = new JTextField(b523d[8]);
