...
import germany.bmw.list.list3.car.detailRepo.B620dRepo;

public class B620d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B620dRepo bRepo = new B620dRepo();
		String[] b620d = bRepo.detail();
		
		JTextField t1 = new JTextField(b620d[1]);
		JTextField t2 = new JTextField(b620d[2] + "円");
		JTextField t3 = new JTextField(b620d[3]);
		JTextField t4 = new JTextField(b620d[4]);
		JTextField t5 = new JTextField(b620d[5]);
		JTextField t6 = new JTextField(b620d[6]);
		JTextField t7 = new JTextField(b620d[7]);
		JTextField t8 = new JTextField(b620d[8]);
