...
import germany.bmw.list.list3.car.detailRepo.X6iRepo;

public class X6i extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X6i(){
		setTitle("X6 xDrive40iの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X6iRepo xRepo = new X6iRepo();
		String[] x6i = xRepo.detail();
		
		JTextField t1 = new JTextField(x6i[1]);
		JTextField t2 = new JTextField(x6i[2] + "円");
		JTextField t3 = new JTextField(x6i[3]);
		JTextField t4 = new JTextField(x6i[4]);
		JTextField t5 = new JTextField(x6i[5]);
		JTextField t6 = new JTextField(x6i[6]);
		JTextField t7 = new JTextField(x6i[7]);
		JTextField t8 = new JTextField(x6i[8]);
