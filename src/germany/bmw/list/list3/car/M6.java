...
import germany.bmw.list.list3.car.detailRepo.M6Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		M6Repo mRepo = new M6Repo();
		String[] m6 = mRepo.detail();
		
		JTextField t1 = new JTextField(m6[1]);
		JTextField t2 = new JTextField(m6[2] + "円");
		JTextField t3 = new JTextField(m6[3]);
		JTextField t4 = new JTextField(m6[4]);
		JTextField t5 = new JTextField(m6[5]);
		JTextField t6 = new JTextField(m6[6]);
		JTextField t7 = new JTextField(m6[7]);
		JTextField t8 = new JTextField(m6[8]);
