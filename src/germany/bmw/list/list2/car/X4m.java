...
import germany.bmw.list.list2.car.detailRepo.X4mRepo;

public class X4m extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		X4mRepo xRepo = new X4mRepo();
		String[] x4m = xRepo.detail();
		
		JTextField t1 = new JTextField(x4m[1]);
		JTextField t2 = new JTextField(x4m[2] + "円");
		JTextField t3 = new JTextField(x4m[3]);
		JTextField t4 = new JTextField(x4m[4]);
		JTextField t5 = new JTextField(x4m[5]);
		JTextField t6 = new JTextField(x4m[6]);
		JTextField t7 = new JTextField(x4m[7]);
		JTextField t8 = new JTextField(x4m[8]);
