...
import germany.bmw.list.list2.car.detailRepo.M3Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		M3Repo mRepo = new M3Repo();
		String[] m3 = mRepo.detail();
		
		JTextField t1 = new JTextField(m3[1]);
		JTextField t2 = new JTextField(m3[2] + "円");
		JTextField t3 = new JTextField(m3[3]);
		JTextField t4 = new JTextField(m3[4]);
		JTextField t5 = new JTextField(m3[5]);
		JTextField t6 = new JTextField(m3[6]);
		JTextField t7 = new JTextField(m3[7]);
		JTextField t8 = new JTextField(m3[8]);
