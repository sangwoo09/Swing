...
import germany.bmw.list.list2.car.detailRepo.B320dRepo;

public class B320d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B320dRepo bRepo = new B320dRepo();
		String[] b320d = bRepo.detail();
		
		JTextField t1 = new JTextField(b320d[1]);
		JTextField t2 = new JTextField(b320d[2] + "円");
		JTextField t3 = new JTextField(b320d[3]);
		JTextField t4 = new JTextField(b320d[4]);
		JTextField t5 = new JTextField(b320d[5]);
		JTextField t6 = new JTextField(b320d[6]);
		JTextField t7 = new JTextField(b320d[7]);
		JTextField t8 = new JTextField(b320d[8]);
