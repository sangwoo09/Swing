...
import germany.bmw.list.list2.car.detailRepo.X3dRepo;

public class X3d extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X3d(){
		setTitle("X3 xDrive20dの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X3dRepo xRepo = new X3dRepo();
		String[] x3d = xRepo.detail();
		
		JTextField t1 = new JTextField(x3d[1]);
		JTextField t2 = new JTextField(x3d[2] + "円");
		JTextField t3 = new JTextField(x3d[3]);
		JTextField t4 = new JTextField(x3d[4]);
		JTextField t5 = new JTextField(x3d[5]);
		JTextField t6 = new JTextField(x3d[6]);
		JTextField t7 = new JTextField(x3d[7]);
		JTextField t8 = new JTextField(x3d[8]);
