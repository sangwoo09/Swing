...
import germany.bmw.list.list2.car.detailRepo.X4dRepo;

public class X4d extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X4d(){
		setTitle("X4 xDrive20dの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X4dRepo xRepo = new X4dRepo();
		String[] x4d = xRepo.detail();
		
		JTextField t1 = new JTextField(x4d[1]);
		JTextField t2 = new JTextField(x4d[2] + "円");
		JTextField t3 = new JTextField(x4d[3]);
		JTextField t4 = new JTextField(x4d[4]);
		JTextField t5 = new JTextField(x4d[5]);
		JTextField t6 = new JTextField(x4d[6]);
		JTextField t7 = new JTextField(x4d[7]);
		JTextField t8 = new JTextField(x4d[8]);
