...
import germany.bmw.list.list2.car.detailRepo.B420dRepo;

public class B420d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B420dRepo bRepo = new B420dRepo();
		String[] b420d = bRepo.detail();
		
		JTextField t1 = new JTextField(b420d[1]);
		JTextField t2 = new JTextField(b420d[2] + "円");
		JTextField t3 = new JTextField(b420d[3]);
		JTextField t4 = new JTextField(b420d[4]);
		JTextField t5 = new JTextField(b420d[5]);
		JTextField t6 = new JTextField(b420d[6]);
		JTextField t7 = new JTextField(b420d[7]);
		JTextField t8 = new JTextField(b420d[8]);
