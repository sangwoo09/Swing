...
import germany.bmw.list.list2.car.detailRepo.B320iRepo;

public class B320i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B320iRepo bRepo = new B320iRepo();
		String[] b320i = bRepo.detail();
		
		JTextField t1 = new JTextField(b320i[1]);
		JTextField t2 = new JTextField(b320i[2] + "円");
		JTextField t3 = new JTextField(b320i[3]);
		JTextField t4 = new JTextField(b320i[4]);
		JTextField t5 = new JTextField(b320i[5]);
		JTextField t6 = new JTextField(b320i[6]);
		JTextField t7 = new JTextField(b320i[7]);
		JTextField t8 = new JTextField(b320i[8]);
