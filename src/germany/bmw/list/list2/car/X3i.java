...
import germany.bmw.list.list2.car.detailRepo.X3iRepo;

public class X3i extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X3i(){
		setTitle("X3 xDrive20iの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X3iRepo xRepo = new X3iRepo();
		String[] x3i = xRepo.detail();
		
		JTextField t1 = new JTextField(x3i[1]);
		JTextField t2 = new JTextField(x3i[2] + "円");
		JTextField t3 = new JTextField(x3i[3]);
		JTextField t4 = new JTextField(x3i[4]);
		JTextField t5 = new JTextField(x3i[5]);
		JTextField t6 = new JTextField(x3i[6]);
		JTextField t7 = new JTextField(x3i[7]);
		JTextField t8 = new JTextField(x3i[8]);
