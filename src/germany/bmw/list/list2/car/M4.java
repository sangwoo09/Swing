...
import germany.bmw.list.list2.car.detailRepo.M4Repo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		M4Repo mRepo = new M4Repo();
		String[] m4 = mRepo.detail();
		
		JTextField t1 = new JTextField(m4[1]);
		JTextField t2 = new JTextField(m4[2] + "円");
		JTextField t3 = new JTextField(m4[3]);
		JTextField t4 = new JTextField(m4[4]);
		JTextField t5 = new JTextField(m4[5]);
		JTextField t6 = new JTextField(m4[6]);
		JTextField t7 = new JTextField(m4[7]);
		JTextField t8 = new JTextField(m4[8]);
