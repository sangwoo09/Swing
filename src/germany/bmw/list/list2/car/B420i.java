...
import germany.bmw.list.list2.car.detailRepo.B420iRepo;

public class B420i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B420iRepo bRepo = new B420iRepo();
		String[] b420i = bRepo.detail();
		
		JTextField t1 = new JTextField(b420i[1]);
		JTextField t2 = new JTextField(b420i[2] + "円");
		JTextField t3 = new JTextField(b420i[3]);
		JTextField t4 = new JTextField(b420i[4]);
		JTextField t5 = new JTextField(b420i[5]);
		JTextField t6 = new JTextField(b420i[6]);
		JTextField t7 = new JTextField(b420i[7]);
		JTextField t8 = new JTextField(b420i[8]);
