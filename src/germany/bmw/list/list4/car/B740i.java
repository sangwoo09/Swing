...
import germany.bmw.list.list4.car.detailRepo.B740iRepo;

public class B740i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B740iRepo bRepo = new B740iRepo();
		String[] b740i = bRepo.detail();
		
		JTextField t1 = new JTextField(b740i[1]);
		JTextField t2 = new JTextField(b740i[2] + "円");
		JTextField t3 = new JTextField(b740i[3]);
		JTextField t4 = new JTextField(b740i[4]);
		JTextField t5 = new JTextField(b740i[5]);
		JTextField t6 = new JTextField(b740i[6]);
		JTextField t7 = new JTextField(b740i[7]);
		JTextField t8 = new JTextField(b740i[8]);
