...
import germany.bmw.list.list4.car.detailRepo.B740dRepo;

public class B740d extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B740dRepo bRepo = new B740dRepo();
		String[] b740d = bRepo.detail();
		
		JTextField t1 = new JTextField(b740d[1]);
		JTextField t2 = new JTextField(b740d[2] + "円");
		JTextField t3 = new JTextField(b740d[3]);
		JTextField t4 = new JTextField(b740d[4]);
		JTextField t5 = new JTextField(b740d[5]);
		JTextField t6 = new JTextField(b740d[6]);
		JTextField t7 = new JTextField(b740d[7]);
		JTextField t8 = new JTextField(b740d[8]);
