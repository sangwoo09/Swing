...
import germany.bmw.list.list4.car.detailRepo.M8Repo;

public class M8 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		M8Repo mRepo = new M8Repo();
		String[] m8 = mRepo.detail();
		
		JTextField t1 = new JTextField(m8[1]);
		JTextField t2 = new JTextField(m8[2] + "円");
		JTextField t3 = new JTextField(m8[3]);
		JTextField t4 = new JTextField(m8[4]);
		JTextField t5 = new JTextField(m8[5]);
		JTextField t6 = new JTextField(m8[6]);
		JTextField t7 = new JTextField(m8[7]);
		JTextField t8 = new JTextField(m8[8]);
