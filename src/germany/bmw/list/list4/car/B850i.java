...
import germany.bmw.list.list4.car.detailRepo.B850iRepo;

public class B850i extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		B850iRepo bRepo = new B850iRepo();
		String[] b850i = bRepo.detail();
		
		JTextField t1 = new JTextField(b850i[1]);
		JTextField t2 = new JTextField(b850i[2] + "円");
		JTextField t3 = new JTextField(b850i[3]);
		JTextField t4 = new JTextField(b850i[4]);
		JTextField t5 = new JTextField(b850i[5]);
		JTextField t6 = new JTextField(b850i[6]);
		JTextField t7 = new JTextField(b850i[7]);
		JTextField t8 = new JTextField(b850i[8]);
