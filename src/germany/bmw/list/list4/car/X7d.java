...
import germany.bmw.list.list4.car.detailRepo.X7dRepo;

public class X7d extends JFrame{

JButton b1 = new JButton("リストに戻る");
	
	public X7d(){
		setTitle("X7 xDrive40dの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		X7dRepo xRepo = new X7dRepo();
		String[] x7d = xRepo.detail();
		
		JTextField t1 = new JTextField(x7d[1]);
		JTextField t2 = new JTextField(x7d[2] + "円");
		JTextField t3 = new JTextField(x7d[3]);
		JTextField t4 = new JTextField(x7d[4]);
		JTextField t5 = new JTextField(x7d[5]);
		JTextField t6 = new JTextField(x7d[6]);
		JTextField t7 = new JTextField(x7d[7]);
		JTextField t8 = new JTextField(x7d[8]);
