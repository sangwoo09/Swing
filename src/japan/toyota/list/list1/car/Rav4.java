...
import japan.toyota.list.list1.car.detailRepo.Rav4Repo;

public class Rav4 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Rav4Repo rRepo = new Rav4Repo();
		String[] rav4 = rRepo.detail();
		
		JTextField t1 = new JTextField(rav4[1]);
		JTextField t2 = new JTextField(rav4[2] + "円");
		JTextField t3 = new JTextField(rav4[3]);
		JTextField t4 = new JTextField(rav4[4]);
		JTextField t5 = new JTextField(rav4[5]);
		JTextField t6 = new JTextField(rav4[6]);
		JTextField t7 = new JTextField(rav4[7]);
		JTextField t8 = new JTextField(rav4[8]);
