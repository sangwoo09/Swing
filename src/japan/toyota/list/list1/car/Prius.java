package japan.toyota.list.list1.car;
...
import japan.toyota.list.list1.List1;
import japan.toyota.list.list1.car.detailRepo.PriusRepo;

public class Prius extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		PriusRepo pRepo = new PriusRepo();
		String[] prius = pRepo.detail();
		
		JTextField t1 = new JTextField(prius[1]);
		JTextField t2 = new JTextField(prius[2] + "円");
		JTextField t3 = new JTextField(prius[3]);
		JTextField t4 = new JTextField(prius[4]);
		JTextField t5 = new JTextField(prius[5]);
		JTextField t6 = new JTextField(prius[6]);
		JTextField t7 = new JTextField(prius[7]);
		JTextField t8 = new JTextField(prius[8]);
