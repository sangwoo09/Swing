...
import japan.toyota.list.list5.car.detailRepo.Gr86Repo;

public class Gr86 extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		Gr86Repo grRepo = new Gr86Repo();
		String[] gr86 = grRepo.detail();
		
		JTextField t1 = new JTextField(gr86[1]);
		JTextField t2 = new JTextField(gr86[2] + "円");
		JTextField t3 = new JTextField(gr86[3]);
		JTextField t4 = new JTextField(gr86[4]);
		JTextField t5 = new JTextField(gr86[5]);
		JTextField t6 = new JTextField(gr86[6]);
		JTextField t7 = new JTextField(gr86[7]);
		JTextField t8 = new JTextField(gr86[8]);
