...
import japan.toyota.list.list3.car.detailRepo.CrownRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		CrownRepo cRepo = new CrownRepo();
		String[] crown = cRepo.detail();
		
		JTextField t1 = new JTextField(crown[1]);
		JTextField t2 = new JTextField(crown[2] + "円");
		JTextField t3 = new JTextField(crown[3]);
		JTextField t4 = new JTextField(crown[4]);
		JTextField t5 = new JTextField(crown[5]);
		JTextField t6 = new JTextField(crown[6]);
		JTextField t7 = new JTextField(crown[7]);
		JTextField t8 = new JTextField(crown[8]);
