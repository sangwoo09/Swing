package japan.toyota.list.list3.car;
...
import japan.toyota.list.list3.List3;
import japan.toyota.list.list3.car.detailRepo.HighlanderRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		HighlanderRepo hRepo = new HighlanderRepo();
		String[] highlander = hRepo.detail();
		
		JTextField t1 = new JTextField(highlander[1]);
		JTextField t2 = new JTextField(highlander[2] + "円");
		JTextField t3 = new JTextField(highlander[3]);
		JTextField t4 = new JTextField(highlander[4]);
		JTextField t5 = new JTextField(highlander[5]);
		JTextField t6 = new JTextField(highlander[6]);
		JTextField t7 = new JTextField(highlander[7]);
		JTextField t8 = new JTextField(highlander[8]);
