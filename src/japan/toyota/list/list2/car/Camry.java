package japan.toyota.list.list2.car;
...
import japan.toyota.list.list2.List2;
import japan.toyota.list.list2.car.detailRepo.CamryRepo;

public class Camry extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		CamryRepo cRepo = new CamryRepo();
		String[] camry = cRepo.detail();
		
		JTextField t1 = new JTextField(camry[1]);
		JTextField t2 = new JTextField(camry[2] + "円");
		JTextField t3 = new JTextField(camry[3]);
		JTextField t4 = new JTextField(camry[4]);
		JTextField t5 = new JTextField(camry[5]);
		JTextField t6 = new JTextField(camry[6]);
		JTextField t7 = new JTextField(camry[7]);
		JTextField t8 = new JTextField(camry[8]);
