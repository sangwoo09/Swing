...
public class HSaveFrame extends JFrame{
	...
	private void Center() {
		...
		b3.addActionListener(e -> {
			...
			boolean result = hrepo.save(syamei, price, nenryo, nenpi, syutsu, toruku, haiki, kudou);
			if(result) {
