package japan.honda.list.list1.car;
...
import japan.honda.list.list1.List1;
import japan.honda.list.list1.car.detailRepo.CrvRepo;

public class Crv extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		CrvRepo cRepo = new CrvRepo();
		String[] crv = cRepo.detail();
		
		JTextField t1 = new JTextField(crv[1]);
		JTextField t2 = new JTextField(crv[2] + "円");
		JTextField t3 = new JTextField(crv[3]);
		JTextField t4 = new JTextField(crv[4]);
		JTextField t5 = new JTextField(crv[5]);
		JTextField t6 = new JTextField(crv[6]);
		JTextField t7 = new JTextField(crv[7]);
		JTextField t8 = new JTextField(crv[8]);
