package japan.honda.list.list3.car;
...
import japan.honda.list.list3.List3;
import japan.honda.list.list3.car.detailRepo.PilotRepo;
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		PilotRepo pRepo = new PilotRepo();
		String[] pilot = pRepo.detail();
		
		JTextField t1 = new JTextField(pilot[1]);
		JTextField t2 = new JTextField(pilot[2] + "円");
		JTextField t3 = new JTextField(pilot[3]);
		JTextField t4 = new JTextField(pilot[4]);
		JTextField t5 = new JTextField(pilot[5]);
		JTextField t6 = new JTextField(pilot[6]);
		JTextField t7 = new JTextField(pilot[7]);
		JTextField t8 = new JTextField(pilot[8]);
