package japan.honda.list.list2.car;
...
import japan.honda.list.list2.List2;
import japan.honda.list.list2.car.detailRepo.AccordRepo;

public class Accord extends JFrame{
...
JButton b1 = new JButton("リストに戻る");
	...
	private void Center() {
		...
		AccordRepo aRepo = new AccordRepo();
		String[] accord = aRepo.detail();
		
		JTextField t1 = new JTextField(accord[1]);
		JTextField t2 = new JTextField(accord[2] + "円");
		JTextField t3 = new JTextField(accord[3]);
		JTextField t4 = new JTextField(accord[4]);
		JTextField t5 = new JTextField(accord[5]);
		JTextField t6 = new JTextField(accord[6]);
		JTextField t7 = new JTextField(accord[7]);
		JTextField t8 = new JTextField(accord[8]);
