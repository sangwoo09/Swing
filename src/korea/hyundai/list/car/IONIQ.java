...
import korea.hyundai.list.car.detailrepo.IoniqRepo;


public class IONIQ extends JFrame{
	...
	private void Center() {
		...
		IoniqRepo iRepo = new IoniqRepo();
		String[] ioniq = iRepo.detail();
		
		JTextField t1 = new JTextField(ioniq[1]);
		JTextField t2 = new JTextField(ioniq[2] + "円");
		JTextField t3 = new JTextField(ioniq[3]);
		JTextField t4 = new JTextField(ioniq[4]);
		JTextField t5 = new JTextField(ioniq[5]);
		JTextField t6 = new JTextField(ioniq[6]);
		JTextField t7 = new JTextField(ioniq[7]);
		JTextField t8 = new JTextField(ioniq[8]);
