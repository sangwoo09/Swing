...
import korea.hyundai.list.car.detailrepo.I30Repo;


public class I30 extends JFrame{
	...
	private void Center() {
		...
		I30Repo iRepo = new I30Repo();
		String[] i30 = iRepo.detail();
		
		JTextField t1 = new JTextField(i30[1]);
		JTextField t2 = new JTextField(i30[2] + "ドル");
		JTextField t3 = new JTextField(i30[3]);
		JTextField t4 = new JTextField(i30[4]);
		JTextField t5 = new JTextField(i30[5]);
		JTextField t6 = new JTextField(i30[6]);
		JTextField t7 = new JTextField(i30[7]);
		JTextField t8 = new JTextField(i30[8]);
