...
import korea.hyundai.list.car.detailrepo.KonaRepo;

public class Kona extends JFrame{
	...
	private void Center() {
		...
		KonaRepo kRepo = new KonaRepo();
		String[] kona = kRepo.detail();
		
		JTextField t1 = new JTextField(kona[1]);
		JTextField t2 = new JTextField(kona[2] + "円");
		JTextField t3 = new JTextField(kona[3]);
		JTextField t4 = new JTextField(kona[4]);
		JTextField t5 = new JTextField(kona[5]);
		JTextField t6 = new JTextField(kona[6]);
		JTextField t7 = new JTextField(kona[7]);
		JTextField t8 = new JTextField(kona[8]);
