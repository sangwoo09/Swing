...
import korea.hyundai.list.car.detailrepo.SonataRepo;
...
public class Sonata extends JFrame{
	...
	private void Center() {
		...
		SonataRepo sRepo = new SonataRepo();
		String[] sonata = sRepo.detail();
		
		JTextField t1 = new JTextField(sonata[1]);
		JTextField t2 = new JTextField(sonata[2] + "円");
		JTextField t3 = new JTextField(sonata[3]);
		JTextField t4 = new JTextField(sonata[4]);
		JTextField t5 = new JTextField(sonata[5]);
		JTextField t6 = new JTextField(sonata[6]);
		JTextField t7 = new JTextField(sonata[7]);
		JTextField t8 = new JTextField(sonata[8]);
