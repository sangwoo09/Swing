...
import korea.hyundai.list.List3;
import korea.hyundai.list.car.detailrepo.SantafeRepo;


public class Santafe extends JFrame{
	...
	private void Center() {
		...
		SantafeRepo sRepo = new SantafeRepo();
		String[] santafe = sRepo.detail();
		
		JTextField t1 = new JTextField(santafe[1]);
		JTextField t2 = new JTextField(santafe[2] + "円");
		JTextField t3 = new JTextField(santafe[3]);
		JTextField t4 = new JTextField(santafe[4]);
		JTextField t5 = new JTextField(santafe[5]);
		JTextField t6 = new JTextField(santafe[6]);
		JTextField t7 = new JTextField(santafe[7]);
		JTextField t8 = new JTextField(santafe[8]);
