...
import korea.hyundai.list.car.detailrepo.I40Repo;


public class I40 extends JFrame{
	...
	private void Center() {
		...
		I40Repo iRepo = new I40Repo();
		String[] i40 = iRepo.detail();
		
		JTextField t1 = new JTextField(i40[1]);
		JTextField t2 = new JTextField(i40[2] + "円");
		JTextField t3 = new JTextField(i40[3]);
		JTextField t4 = new JTextField(i40[4]);
		JTextField t5 = new JTextField(i40[5]);
		JTextField t6 = new JTextField(i40[6]);
		JTextField t7 = new JTextField(i40[7]);
		JTextField t8 = new JTextField(i40[8]);
