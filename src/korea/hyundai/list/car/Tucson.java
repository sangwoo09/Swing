...
import korea.hyundai.list.car.detailrepo.TucsonRepo;
...
public class Tucson extends JFrame{
	...
	private void Center() {
		...
		TucsonRepo tRepo = new TucsonRepo();
		String[] tucson = tRepo.detail();
		
		JTextField t1 = new JTextField(tucson[1]);
		JTextField t2 = new JTextField(tucson[2] + "円");
		JTextField t3 = new JTextField(tucson[3]);
		JTextField t4 = new JTextField(tucson[4]);
		JTextField t5 = new JTextField(tucson[5]);
		JTextField t6 = new JTextField(tucson[6]);
		JTextField t7 = new JTextField(tucson[7]);
		JTextField t8 = new JTextField(tucson[8]);
