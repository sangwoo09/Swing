...
import korea.hyundai.list.car.detailrepo.AvanteRepo;


public class Avante extends JFrame{
	...
	private void Center() {
		...
		AvanteRepo aRepo = new AvanteRepo();
		String[] avante = aRepo.detail();
		
		JTextField t1 = new JTextField(avante[1]);
		JTextField t2 = new JTextField(avante[2] + "円");
		JTextField t3 = new JTextField(avante[3]);
		JTextField t4 = new JTextField(avante[4]);
		JTextField t5 = new JTextField(avante[5]);
		JTextField t6 = new JTextField(avante[6]);
		JTextField t7 = new JTextField(avante[7]);
		JTextField t8 = new JTextField(avante[8]);
