...
import korea.hyundai.list.car.detailrepo.VenueRepo;
...
public class Venue extends JFrame{
	...
	private void Center() {
		...
		VenueRepo vRepo = new VenueRepo();
		String[] venue = vRepo.detail();
		
		JTextField t1 = new JTextField(venue[1]);
		JTextField t2 = new JTextField(venue[2] + "円");
		JTextField t3 = new JTextField(venue[3]);
		JTextField t4 = new JTextField(venue[4]);
		JTextField t5 = new JTextField(venue[5]);
		JTextField t6 = new JTextField(venue[6]);
		JTextField t7 = new JTextField(venue[7]);
		JTextField t8 = new JTextField(venue[8]);
