...
import korea.hyundai.list.List1;
import korea.hyundai.list.car.detailrepo.AccentRepo;

public class Accent extends JFrame{
	...
	private void Center() {
		...
		AccentRepo aRepo = new AccentRepo();
		String[] accent = aRepo.detail();
		...
		JTextField t1 = new JTextField(accent[1]);
		JTextField t2 = new JTextField(accent[2] + "円");
		JTextField t3 = new JTextField(accent[3]);
		JTextField t4 = new JTextField(accent[4]);
		JTextField t5 = new JTextField(accent[5]);
		JTextField t6 = new JTextField(accent[6]);
		JTextField t7 = new JTextField(accent[7]);
		JTextField t8 = new JTextField(accent[8]);
