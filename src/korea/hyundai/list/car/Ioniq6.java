...
import korea.hyundai.list.car.detailrepo.Ioniq6Repo;


public class Ioniq6 extends JFrame{
	...
	private void Center() {
		...
		Ioniq6Repo iRepo = new Ioniq6Repo();
		String[] ioniq6 = iRepo.detail();
		
		JTextField t1 = new JTextField(ioniq6[1]);
		JTextField t2 = new JTextField(ioniq6[2] + "円");
		JTextField t3 = new JTextField(ioniq6[3]);
		JTextField t4 = new JTextField(ioniq6[4]);
		JTextField t5 = new JTextField(ioniq6[5]);
		JTextField t6 = new JTextField(ioniq6[6]);
		JTextField t7 = new JTextField(ioniq6[7]);
		JTextField t8 = new JTextField(ioniq6[8]);
