...
public class KSaveFrame extends JFrame{
	...
	private void Center() {
		...
		b3.addActionListener(e -> {
			...
			boolean result = kRepo.save(syamei, price, nenryo, nenpi, syutsu, toruku, haiki, kudou);
			if(result) {
