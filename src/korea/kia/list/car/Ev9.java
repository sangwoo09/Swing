...
import korea.kia.list.car.kdetailrepo.Ev9Repo;


public class Ev9 extends JFrame{
	...
	private void Center() {
		...
		Ev9Repo eRepo = new Ev9Repo();
		String[] ev9 = eRepo.detail();
		
		JTextField t1 = new JTextField(ev9[1]);
		JTextField t2 = new JTextField(ev9[2] + "円");
		JTextField t3 = new JTextField(ev9[3]);
		JTextField t4 = new JTextField(ev9[4]);
		JTextField t5 = new JTextField(ev9[5]);
		JTextField t6 = new JTextField(ev9[6]);
		JTextField t7 = new JTextField(ev9[7]);
		JTextField t8 = new JTextField(ev9[8]);
