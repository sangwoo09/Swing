...
import korea.kia.list.car.kdetailrepo.K5Repo;


public class K5 extends JFrame{
	...
	private void Center() {
		...
		K5Repo kRepo = new K5Repo();
		String[] k5 = kRepo.detail();
		
		JTextField t1 = new JTextField(k5[1]);
		JTextField t2 = new JTextField(k5[2] + "円");
		JTextField t3 = new JTextField(k5[3]);
		JTextField t4 = new JTextField(k5[4]);
		JTextField t5 = new JTextField(k5[5]);
		JTextField t6 = new JTextField(k5[6]);
		JTextField t7 = new JTextField(k5[7]);
		JTextField t8 = new JTextField(k5[8]);
