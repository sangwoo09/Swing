...
import korea.kia.list.car.kdetailrepo.NiroRepo;


public class Niro extends JFrame{
	...
	private void Center() {
		...
		NiroRepo nRepo = new NiroRepo();
		String[] niro = nRepo.detail();
		...
		JTextField t1 = new JTextField(niro[1]);
		JTextField t2 = new JTextField(niro[2] + "円");
		JTextField t3 = new JTextField(niro[3]);
		JTextField t4 = new JTextField(niro[4]);
		JTextField t5 = new JTextField(niro[5]);
		JTextField t6 = new JTextField(niro[6]);
		JTextField t7 = new JTextField(niro[7]);
		JTextField t8 = new JTextField(niro[8]);
