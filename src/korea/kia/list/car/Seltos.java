...
import korea.kia.list.car.kdetailrepo.SeltosRepo;


public class Seltos extends JFrame{
	...
	private void Center() {
		...
		SeltosRepo sRepo = new SeltosRepo();
		String[] seltos = sRepo.detail();
		...
		JTextField t1 = new JTextField(seltos[1]);
		JTextField t2 = new JTextField(seltos[2] + "円");
		JTextField t3 = new JTextField(seltos[3]);
		JTextField t4 = new JTextField(seltos[4]);
		JTextField t5 = new JTextField(seltos[5]);
		JTextField t6 = new JTextField(seltos[6]);
		JTextField t7 = new JTextField(seltos[7]);
		JTextField t8 = new JTextField(seltos[8]);
