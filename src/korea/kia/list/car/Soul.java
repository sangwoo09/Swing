...
import korea.kia.list.car.kdetailrepo.SoulRepo;


public class Soul extends JFrame{
	...
	private void Center() {
		...
		SoulRepo sRepo = new SoulRepo();
		String[] soul = sRepo.detail();
		...
		JTextField t1 = new JTextField(soul[1]);
		JTextField t2 = new JTextField(soul[2] + "円");
		JTextField t3 = new JTextField(soul[3]);
		JTextField t4 = new JTextField(soul[4]);
		JTextField t5 = new JTextField(soul[5]);
		JTextField t6 = new JTextField(soul[6]);
		JTextField t7 = new JTextField(soul[7]);
		JTextField t8 = new JTextField(soul[8]);
