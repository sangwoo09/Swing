...
import korea.kia.list.car.kdetailrepo.SportageRepo;


public class Sportage extends JFrame{
	
	JButton b1 = new JButton("リストに戻る");
	
	public Sportage(){
		setTitle("SPORTAGEの情報");
		setSize(400, 300);
	...
	private void Center() {
		...
		SportageRepo sRepo = new SportageRepo();
		String[] sportage = sRepo.detail();
		
		JTextField t1 = new JTextField(sportage[1]);
		JTextField t2 = new JTextField(sportage[2] + "円");
		JTextField t3 = new JTextField(sportage[3]);
		JTextField t4 = new JTextField(sportage[4]);
		JTextField t5 = new JTextField(sportage[5]);
		JTextField t6 = new JTextField(sportage[6]);
		JTextField t7 = new JTextField(sportage[7]);
		JTextField t8 = new JTextField(sportage[8]);
