...
import korea.kia.list.car.kdetailrepo.Ev6Repo;


public class Ev6 extends JFrame{
	...
	private void Center() {
		...
		Ev6Repo eRepo = new Ev6Repo();
		String[] ev6 = eRepo.detail();
		
		JTextField t1 = new JTextField(ev6[1]);
		JTextField t2 = new JTextField(ev6[2] + "円");
		JTextField t3 = new JTextField(ev6[3]);
		JTextField t4 = new JTextField(ev6[4]);
		JTextField t5 = new JTextField(ev6[5]);
		JTextField t6 = new JTextField(ev6[6]);
		JTextField t7 = new JTextField(ev6[7]);
		JTextField t8 = new JTextField(ev6[8]);
