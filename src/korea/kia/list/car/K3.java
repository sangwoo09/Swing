...
import korea.kia.list.car.kdetailrepo.K3Repo;
...
public class K3 extends JFrame{
	...
	private void Center() {
		...
		K3Repo kRepo = new K3Repo();
		String[] k3 = kRepo.detail();
		...
		JTextField t1 = new JTextField(k3[1]);
		JTextField t2 = new JTextField(k3[2] + "円");
		JTextField t3 = new JTextField(k3[3]);
		JTextField t4 = new JTextField(k3[4]);
		JTextField t5 = new JTextField(k3[5]);
		JTextField t6 = new JTextField(k3[6]);
		JTextField t7 = new JTextField(k3[7]);
		JTextField t8 = new JTextField(k3[8]);
