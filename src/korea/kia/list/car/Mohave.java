...
import korea.kia.list.car.kdetailrepo.MohaveRepo;


public class Mohave extends JFrame{
	...
	private void Center() {
		...
		MohaveRepo mRepo = new MohaveRepo();
		String[] mohave = mRepo.detail();
		
		JTextField t1 = new JTextField(mohave[1]);
		JTextField t2 = new JTextField(mohave[2] + "円");
		JTextField t3 = new JTextField(mohave[3]);
		JTextField t4 = new JTextField(mohave[4]);
		JTextField t5 = new JTextField(mohave[5]);
		JTextField t6 = new JTextField(mohave[6]);
		JTextField t7 = new JTextField(mohave[7]);
		JTextField t8 = new JTextField(mohave[8]);
