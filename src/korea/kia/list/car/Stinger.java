...
import korea.kia.list.car.kdetailrepo.StingerRepo;


public class Stinger extends JFrame{
	...
	private void Center() {
		...
		StingerRepo sRepo = new StingerRepo();
		String[] stinger = sRepo.detail();
		
		JTextField t1 = new JTextField(stinger[1]);
		JTextField t2 = new JTextField(stinger[2] + "円");
		JTextField t3 = new JTextField(stinger[3]);
		JTextField t4 = new JTextField(stinger[4]);
		JTextField t5 = new JTextField(stinger[5]);
		JTextField t6 = new JTextField(stinger[6]);
		JTextField t7 = new JTextField(stinger[7]);
		JTextField t8 = new JTextField(stinger[8]);
