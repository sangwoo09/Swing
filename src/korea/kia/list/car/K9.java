...
import korea.kia.list.car.kdetailrepo.K9Repo;


public class K9 extends JFrame{
	...
	private void Center() {
		...
		K9Repo kRepo = new K9Repo(); 
		String[] k9 = kRepo.detail();
		
		JTextField t1 = new JTextField(k9[1]);
		JTextField t2 = new JTextField(k9[2] + "円");
		JTextField t3 = new JTextField(k9[3]);
		JTextField t4 = new JTextField(k9[4]);
		JTextField t5 = new JTextField(k9[5]);
		JTextField t6 = new JTextField(k9[6]);
		JTextField t7 = new JTextField(k9[7]);
		JTextField t8 = new JTextField(k9[8]);
