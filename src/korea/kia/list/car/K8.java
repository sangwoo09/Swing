...
import korea.kia.list.car.kdetailrepo.K8Repo;


public class K8 extends JFrame{
	...
	private void Center() {
		...
		K8Repo kRepo = new K8Repo();
		String[] k8 = kRepo.detail();
		
		JTextField t1 = new JTextField(k8[1]);
		JTextField t2 = new JTextField(k8[2] + "円");
		JTextField t3 = new JTextField(k8[3]);
		JTextField t4 = new JTextField(k8[4]);
		JTextField t5 = new JTextField(k8[5]);
		JTextField t6 = new JTextField(k8[6]);
		JTextField t7 = new JTextField(k8[7]);
		JTextField t8 = new JTextField(k8[8]);
